...
class sps_iniciou_pre_matricula extends Evento {
    ...
    public function cast_values(array $data) {
        return [
            ...
            'tipo' => 144, // Evento Rubeus: Iniciou Pré-Matrícula
            'codCurso' => $data['bk_curso'],
            'codOferta' => $data['bk_oferta'],
            'descricao' => "<p>Esta pessoa iniciou a pré-matrícula no curso <strong>{$data['bk_oferta']}</strong></p>",
        ];
    }
}
