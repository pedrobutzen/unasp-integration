...
class mestrado_pagamento_aprovado extends Evento {
    ...
    public function cast_values(array $data) {
        return [
            ...
            'tipo' => 328, //Pagamento Aprovado (Mestrado)
            'codCurso' => $data['bk_curso'],
            'codOferta' => $data['bk_oferta'],
            'descricao' => "<p>Pagamento aprovado para o curso {$data['bk_oferta']} no processo de Mestrado.</p>",
        ];
    }
}
