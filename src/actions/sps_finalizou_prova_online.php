...
class sps_finalizou_prova_online extends Evento {
    ...
    public function cast_values(array $data) {
        return [
            ...
            'tipo' => 317, // Evento Rubeus: Finalizou Prova Online
            'codCurso' => $data['bk_curso'],
            'codOferta' => $data['bk_oferta'],
            'descricao' => "<p>Prova online finalizada pelo candidato para o curso {$data['bk_oferta']}</p>",
        ];
    }
}
