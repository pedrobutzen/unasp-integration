...
class sps_matricula_liberada extends Evento {
    ...
    public function cast_values(array $data) {
        return [
            ...
            'tipo' => 64, // Evento Rubeus: Matrícula foi Liberada
            'codCurso' => $data['bk_curso'],
            'codOferta' => $data['bk_oferta'],
            'descricao' => "<p>A matrícula no curso {$data['bk_oferta']} foi liberada para essa pessoa.</p>",
        ];
    }
}
